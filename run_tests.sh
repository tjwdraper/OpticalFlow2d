...
g++ -std=c++20 ./build/mainTest.o ./build/testCoord2d.o ./build/testField.o ./build/testImage.o ./build/testMotion.o ./build/testConv2d.o ./build/testInterp2d.o ./build/testGradients.o -o ./build/testOpticalFlow2d -L/usr/local/lib -lgtest
